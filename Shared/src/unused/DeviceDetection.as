...
//            device.major = -1;
//            device.minor = -1;
//            device.longEdge = Capabilities.screenResolutionY;
//            device.shortEdge = Capabilities.screenResolutionX;
//            device.ppi = Capabilities.screenDPI;
//            device.scale = 1;
//        }
//
//        device.isPortrait = Capabilities.screenResolutionY < Capabilities.screenResolutionX;
//
//        if(os.match(/windows/)) {
...
//    }
//
//    public static function clearDeviceCache():void {
//        deviceInfo_cache = false;
//    }
}
}
